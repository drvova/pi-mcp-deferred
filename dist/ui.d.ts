...
export declare function show_oauth_server_picker(ctx: ExtensionCommandContext, servers: Map<string, ServerState>, action: 'login' | 'logout'): Promise<string | undefined>;

import type { Component, OverlayOptions, SelectItem, SelectListLayoutOptions, SettingItem } from '@earendil-works/pi-tui';
export type ModalColor = 'accent' | 'muted' | 'dim' | 'warning' | 'success';
...
export interface PickerModalOptions {
    ...
    subtitle?: ModalText;
    footer?: ModalText;
    selected_footer?: (item: SelectItem | undefined) => string | string[] | undefined;
    overlay_options?: OverlayOptions;
    style?: ModalStyle;
    items: SelectItem[];
